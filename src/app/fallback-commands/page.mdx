...
You can use the [Manage fallback commands](vicinae://launch/vicinae/manage-fallback) command to select what commands or shortcuts are eligible to be fallback commands.
