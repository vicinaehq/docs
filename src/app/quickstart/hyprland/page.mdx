...
Vicinae supports global shortcuts through the `ext-hotkey-v1` wayland protocol. You can build Hyprland from [this PR](https://github.com/hyprwm/Hyprland/pull/15010) if you want support.
