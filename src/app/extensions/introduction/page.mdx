...
This page explains this design choice and gives a sneak peek at what extension code looks like. For a step-by-step guide on creating an extension, see the [getting started](extensions/start) page.
...
## Where are you hiding the browser?
...
For this reason, our API follows the Raycast API very closely but also offers exclusive APIs.
