...
<Warning>
Settings are stored in a JSON file within Vicinae's configuration directory. While this file exists, it's not intended for manual editing—the format may change in future versions and the file location isn't guaranteed to remain stable.
</Warning>
