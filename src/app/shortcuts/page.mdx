...
In order to create a shortcut, simply launch the [Create Shortcut](vicinae://launch/shortcut/create) command:
...
The [Manage Shortcuts](vicinae://launch/shortcut/manage) command lists all your existing shortcuts and allows you to open, edit, duplicate, or remove any shortcut from the list.
