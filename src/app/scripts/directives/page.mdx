...
| `@vicinae.icon` | Icon to show in the root search. Can be a file path, an emoji or an HTTPS url. Relative file paths are relative to the directory in which the script is located. | Yes |
