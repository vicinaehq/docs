...
<Warning>
The intended way to consume the AppImage build is to install Vicinae using the [script](/install/linux#install-script). This page documents how to build the AppImage from source using the AppImage build environment. This page is mostly intended for Vicinae developers.
</Warning>
