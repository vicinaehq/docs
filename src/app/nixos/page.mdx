...
When installing the extension via nix, extension name will be somethint like @author/ext-name-id, in the provided example,
it's **@knoopx**/**nix**-**0**.  
To get that name, you can first install the extension either via the home-manager option or vicinae store, then go to your 
installed extension, hit ctrl+b and copy author and ID.
