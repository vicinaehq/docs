...
This will vary depending on the fields that each extension expects. (There could be some more documentation on the formula for determining the provider, or change it to accept a deeplink for consistency)
