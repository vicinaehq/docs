...
- We don't send personally identifiable information: the `userId` is unique to vicinae and does *not* use your machine ID. It cannot be used to track you outside of vicinae.
...
For users based in EU member states: processing is based on legitimate interest under [Article 6(1)(e-f)](https://gdpr-info.eu/art-6-gdpr/) of GDPR. This is compatible with opt-out telemetry.
